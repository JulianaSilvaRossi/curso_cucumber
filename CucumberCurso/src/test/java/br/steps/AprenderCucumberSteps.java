...
import br.converters.DateConverter;
...
public class AprenderCucumberSteps {
	...
	@Quando("^a entega atrasar em (\\d+) (dia|dias|mes|meses)$")
	public void aEntegaAtrasarEmDias(int arg1, String tempo) throws Throwable {
		Calendar cal = Calendar.getInstance();
		cal.setTime(entrega);
