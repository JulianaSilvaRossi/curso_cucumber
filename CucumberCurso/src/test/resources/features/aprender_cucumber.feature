...
Cenário: Deve calcular atraso na entrega
	...
	Quando a entega atrasar em 2 dias
	Então a entrega serra efetuada em 07/04/2018
	
@tipo1 @tipo2
Cenário: Deve calcular atraso na entrega na China

	Dado que a entrega é dia 05/04/2018
	Quando a entega atrasar em 2 meses
	Então a entrega serra efetuada em 05/06/2018
